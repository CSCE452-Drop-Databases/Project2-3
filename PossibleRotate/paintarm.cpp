...
void PaintArm::rotate(int joint_index, double rotation_in_deg) {
	...
	if (joint_index == 2){
		//rotate joint 2
		_T_Matrices[joint_index]->assign_element(0, 0, deci_round(cos(theta_in_rads + _T_Matrices[joint_index]->matrix[0][0])));
		_T_Matrices[joint_index]->assign_element(0, 1, deci_round(-1*sin(theta_in_rads + _T_Matrices[joint_index]->matrix[0][1])));
		_T_Matrices[joint_index]->assign_element(1, 0, deci_round(sin(theta_in_rads + _T_Matrices[joint_index]->matrix[1][0])));
		_T_Matrices[joint_index]->assign_element(1, 1, deci_round(-1*cos(theta_in_rads + _T_Matrices[joint_index]->matrix[1][1])));

		//rotate joint 3
		_T_Matrices[joint_index+1]->assign_element(0, 0, deci_round(cos(theta_in_rads + _T_Matrices[joint_index+1]->matrix[0][0])));
		_T_Matrices[joint_index+1]->assign_element(0, 1, deci_round(-1*sin(theta_in_rads + _T_Matrices[joint_index+1]->matrix[0][1])));
		_T_Matrices[joint_index+1]->assign_element(1, 0, deci_round(sin(theta_in_rads + _T_Matrices[joint_index+1]->matrix[1][0])));
		_T_Matrices[joint_index+1]->assign_element(1, 1, deci_round(-1*cos(theta_in_rads + _T_Matrices[joint_index+1]->matrix[1][1])));
		}
